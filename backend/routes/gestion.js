    ...
    router.post('/gestion/ajustar-tarifa/:id', jsonParser, async (req, res) => {
        ...
        try {
            ...
            if (tipoAjuste === 'porcentaje') {
                ...
                const valorReal = reservaData.valorCLP;
                ...
                const valorPotencial = reservaData.valorCLP;
                dataToUpdate.valorPotencialCLP = valorPotencial;
                dataToUpdate.valorCLP = valorRealPagado;
    ...
    router.post('/gestion/documento/eliminar', jsonParser, async (req, res) => {
        ...
        try {
            ...
            if (tipoDoc === 'transaccion') {
                ...
                if (transaccionDoc.exists && transaccionDoc.data().enlaceComprobante !== 'SIN_DOCUMENTO') {
                ...
                if (reservaData.documentos && reservaData.documentos[tipoDoc] !== 'SIN_DOCUMENTO') {
            ...
            if (filePath) {
                ...
                await file.delete().catch(err => console.error(`No se pudo borrar el archivo ${filePath}:`, err.message));
            }
